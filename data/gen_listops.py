...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--max_args", type=int, default=10, help="Maximum number of arguments per operator in training sequences."
    )
    parser.add_argument(
        "--max_length", type=int, default=2000, help="Maximum length per sequence in training sequences."
    )
    parser.add_argument(
        "--min_length", type=int, default=500, help="Minimum length per sequence in training sequences."
    )
